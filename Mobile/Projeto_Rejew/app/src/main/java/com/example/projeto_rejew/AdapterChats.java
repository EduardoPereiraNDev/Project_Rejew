...
public class AdapterChats extends RecyclerView.Adapter<AdapterChats.ChatViewHolder> {

    private List<Chat> chats;
    private final Context context;
    private final ChatAPIController chatAPIController;
    private static final int LARGURA_PADRAO = 1000;
    private static final int ALTURA_PADRAO = 1000;

    public AdapterChats(Context context, List<Chat> chats, ChatAPIController chatAPIController) {
    ...
    public ChatViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_adapter_chats, parent, false);
    ...
    public void onBindViewHolder(@NonNull ChatViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(context, Chat_Genero.class);
